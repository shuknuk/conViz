...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "com.traceview.gui/com.traceview.gui.TraceViewApplication"
...
@rem Execute gui
"%JAVA_EXE%" %JAVA_OPTS% %GUI_OPTS% %DEFAULT_JVM_OPTS% %*
